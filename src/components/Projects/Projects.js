        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description={`Création d'un système de détection de triche aux examens basé sur la vidéo. Utilisation de modèles de détection de mouvement et d'analyse d'activité visuelle pour repérer les comportements suspects. Système extensible avec une future intégration de la détection audio. Déployable via une interface web.<br /><br />**Technologies utilisées :** OpenCV, PyTorch, FastAPI, JavaScript, HTML`}
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description={`Développement complet d'une plateforme web pour analyser les avis de livres, films ou séries. Le système intègre des modules d'IA pour effectuer des résumés objectifs, détecter les sentiments, et établir un profil psychologique des utilisateurs à partir de leurs anciens avis. L'architecture est modulaire et documentée, avec gestion des appels via un proxy Vite/React et déploiement en conteneurs.<br /><br />**Technologies utilisées :** FastAPI, React, OpenAI API, Hugging Face Transformers, PyTorch, PostgreSQL, Docker`}
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description={`Développement d'une application complète destinée aux pratiquants de musculation avec budget serré. Le système calcule les besoins journaliers en macros à partir de paramètres individuels puis génère automatiquement un menu hebdomadaire optimisé, une liste de courses adaptée au budget, et des recettes simples.<br /><br />**Technologies utilisées :** FastAPI, React, Python, Pydantic, MVC, PostgreSQL, Docker`}
